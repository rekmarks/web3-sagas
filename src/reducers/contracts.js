...
// for uuidv5
// contract type are created using the contract bytecode (see call below)
// think of the resulting uuid as a hash of the contract artifact to help
// prevent the addition of duplicate contracts
const namespace = '452cc091-8289-4ebc-9ff3-02ce3f75cd53'
...
const initialState = {
  ...
  // false if a web3-related call has yet to complete, preventing further web3
  // calls
  ready: true,
...
async function deployContract (
  ...
  dispatch(getDeploymentSuccessAction(uuidv4(), deploymentData))
