...
var initialState = {
  contracts: _objectSpread({}, _contracts.initialState),
  web3: _objectSpread({}, _web.initialState)
};
...
var sagas = [].concat(_toConsumableArray(_web.sagas), _toConsumableArray(_contracts.sagas));
exports.sagas = sagas;
